...
*/
	static String  GetResourceName (EResourceType type, uint64_t id)
	{
		...
		switch ( type )
		{
			...
			case VK_OBJECT_TYPE_ACCELERATION_STRUCTURE_KHR:		break;
			case VK_OBJECT_TYPE_BUFFER_COLLECTION_FUCHSIA:		break;
			case VK_OBJECT_TYPE_CU_FUNCTION_NVX:		break;
			case VK_OBJECT_TYPE_CU_MODULE_NVX:		break;
			case VK_OBJECT_TYPE_DEFERRED_OPERATION_KHR:		break;
			case VK_OBJECT_TYPE_INDIRECT_COMMANDS_LAYOUT_NV:		break;
			case VK_OBJECT_TYPE_PRIVATE_DATA_SLOT_EXT:		break;
		}
		END_ENUM_CHECKS();
