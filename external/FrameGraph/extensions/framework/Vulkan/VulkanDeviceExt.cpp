...
*/
	ND_ static VkObjectType  DebugReportObjectTypeToObjectType (VkDebugReportObjectTypeEXT objType)
	{
		...
		switch ( objType )
		{
			...
			case VK_DEBUG_REPORT_OBJECT_TYPE_ACCELERATION_STRUCTURE_KHR_EXT: break;
			case VK_DEBUG_REPORT_OBJECT_TYPE_BUFFER_COLLECTION_FUCHSIA_EXT: break;
			case VK_DEBUG_REPORT_OBJECT_TYPE_CU_FUNCTION_NVX_EXT: break;
			case VK_DEBUG_REPORT_OBJECT_TYPE_CU_MODULE_NVX_EXT: break;
...
*/
	...
	{
		if ( name.empty() or (void*)id == VK_NULL_HANDLE )
			return false;
