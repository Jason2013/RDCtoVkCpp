    ...
    extern PFN_vkGetPhysicalDeviceToolProperties  _var_vkGetPhysicalDeviceToolProperties;
    ...
    extern PFN_vkGetPhysicalDeviceFragmentShadingRatesKHR  _var_vkGetPhysicalDeviceFragmentShadingRatesKHR;
    ...
    extern PFN_vkGetDrmDisplayEXT  _var_vkGetDrmDisplayEXT;
...
# endif // VULKAN_WAYLAND_H_
    ...
    PFN_vkGetPhysicalDeviceToolProperties  _var_vkGetPhysicalDeviceToolProperties = null;
    ...
    PFN_vkGetPhysicalDeviceFragmentShadingRatesKHR  _var_vkGetPhysicalDeviceFragmentShadingRatesKHR = null;
    ...
    PFN_vkGetDrmDisplayEXT  _var_vkGetDrmDisplayEXT = null;
...
# endif // VULKAN_WAYLAND_H_
    ...
    ND_ VKAPI_ATTR forceinline VkResult vkGetPhysicalDeviceToolProperties (VkPhysicalDevice physicalDevice, uint32_t* pToolCount, VkPhysicalDeviceToolProperties* pToolProperties) { return _var_vkGetPhysicalDeviceToolProperties( physicalDevice, pToolCount, pToolProperties ); }
    ...
    ND_ VKAPI_ATTR forceinline VkResult vkGetPhysicalDeviceFragmentShadingRatesKHR (VkPhysicalDevice physicalDevice, uint32_t* pFragmentShadingRateCount, VkPhysicalDeviceFragmentShadingRateKHR* pFragmentShadingRates) { return _var_vkGetPhysicalDeviceFragmentShadingRatesKHR( physicalDevice, pFragmentShadingRateCount, pFragmentShadingRates ); }
    ...
    ND_ VKAPI_ATTR forceinline VkResult vkGetDrmDisplayEXT (VkPhysicalDevice physicalDevice, int32_t drmFd, uint32_t connectorId, VkDisplayKHR* display) { return _var_vkGetDrmDisplayEXT( physicalDevice, drmFd, connectorId, display ); }
...
# endif // VULKAN_WAYLAND_H_
    ...
    VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkGetPhysicalDeviceToolProperties (VkPhysicalDevice , uint32_t* , VkPhysicalDeviceToolProperties* ) {  FG_LOGI( "used dummy function 'vkGetPhysicalDeviceToolProperties'" );  return VK_RESULT_MAX_ENUM;  }
    ...
    VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkEnumeratePhysicalDeviceQueueFamilyPerformanceQueryCountersKHR (VkPhysicalDevice , uint32_t , uint32_t* , VkPerformanceCounterKHR* , VkPerformanceCounterDescriptionKHR* ) {  FG_LOGI( "used dummy function 'vkEnumeratePhysicalDeviceQueueFamilyPerformanceQueryCountersKHR'" );  return VK_RESULT_MAX_ENUM;  }
    VKAPI_ATTR void VKAPI_CALL Dummy_vkGetPhysicalDeviceQueueFamilyPerformanceQueryPassesKHR (VkPhysicalDevice , const VkQueryPoolPerformanceCreateInfoKHR* , uint32_t* ) {  FG_LOGI( "used dummy function 'vkGetPhysicalDeviceQueueFamilyPerformanceQueryPassesKHR'" );  return ;  }
    ...
    VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkGetPhysicalDeviceFragmentShadingRatesKHR (VkPhysicalDevice , uint32_t* , VkPhysicalDeviceFragmentShadingRateKHR* ) {  FG_LOGI( "used dummy function 'vkGetPhysicalDeviceFragmentShadingRatesKHR'" );  return VK_RESULT_MAX_ENUM;  }
    ...
    VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkGetPhysicalDeviceToolPropertiesEXT (VkPhysicalDevice , uint32_t* , VkPhysicalDeviceToolProperties* ) {  FG_LOGI( "used dummy function 'vkGetPhysicalDeviceToolPropertiesEXT'" );  return VK_RESULT_MAX_ENUM;  }
    ...
    VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkAcquireDrmDisplayEXT (VkPhysicalDevice , int32_t , VkDisplayKHR ) {  FG_LOGI( "used dummy function 'vkAcquireDrmDisplayEXT'" );  return VK_RESULT_MAX_ENUM;  }
    VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkGetDrmDisplayEXT (VkPhysicalDevice , int32_t , uint32_t , VkDisplayKHR* ) {  FG_LOGI( "used dummy function 'vkGetDrmDisplayEXT'" );  return VK_RESULT_MAX_ENUM;  }
    VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkAcquireWinrtDisplayNV (VkPhysicalDevice , VkDisplayKHR ) {  FG_LOGI( "used dummy function 'vkAcquireWinrtDisplayNV'" );  return VK_RESULT_MAX_ENUM;  }
    VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkGetWinrtDisplayNV (VkPhysicalDevice , uint32_t , VkDisplayKHR* ) {  FG_LOGI( "used dummy function 'vkGetWinrtDisplayNV'" );  return VK_RESULT_MAX_ENUM;  }
# ifdef VULKAN_WIN32_H_
...
# endif // VULKAN_WAYLAND_H_
    ...
    Load( OUT _var_vkGetPhysicalDeviceToolProperties, "vkGetPhysicalDeviceToolProperties", Dummy_vkGetPhysicalDeviceToolProperties );
    ...
    Load( OUT _var_vkGetPhysicalDeviceFragmentShadingRatesKHR, "vkGetPhysicalDeviceFragmentShadingRatesKHR", Dummy_vkGetPhysicalDeviceFragmentShadingRatesKHR );
    ...
    Load( OUT _var_vkGetDrmDisplayEXT, "vkGetDrmDisplayEXT", Dummy_vkGetDrmDisplayEXT );
